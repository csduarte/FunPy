...
# file for appending; any data written to the file is automatically added
# to the end. 'r+' opens the file for both reading and writing. The mode argument
